                    ...
                    <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            <?php foreach ($categories as $category): ?>
                                <?php $id=$category['id'];?>
                                <tr>
                                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo ++$idx?></strong></td>
                                                    ...
                                                    <form method="post" action="<?=base_url('category/update/'.$id)?>">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-12 space-x-6 d-flex">
                                                                <input type="text" class="form-control" id="basic-default-name" value="<?=esc($category['name']); ?>" />
